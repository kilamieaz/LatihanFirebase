...
import com.example.latihanfirebase.Add_Data.Add_Data_Act
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(
            ...
            R.string.default_web_client_id  // dari google json
        )).requestEmail().build()
    ...
    // button di klik jalankan fungsi ini dan akan mengarah ke onActivityResult
    private fun signIn(){
        val signInIntent = mGoogleSignInClient.signInIntent
        startActivityForResult(signInIntent, RC_SIGN_IN)
    }

    //jika berhasil maka jalankan fungsi updateUI()
...
//            Toast.makeText(this, "Hello " + "${user.displayName}", Toast.LENGTH_SHORT).show()
    ...
    // mendapatkan request dari SignIn() jika data nya benar maka jalankan fungsi firebaseAuthWithGoogle
    ...
    //jika sudah login maka langsung eksekusi
